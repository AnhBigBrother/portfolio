	...
	return (
		<motion.section
			...
			<p className='mb-5'>
				...
				major in <span className='font-semibold'>Mechatronics Engineering</span>. During my university years, I tried programming and found my passion for it. I'm an{" "}
				<span className='font-semibold'>algorithms enthusiast</span>, who enjoys solving <span className='font-semibold'>Leetcode algorithm problems</span> and participating in{" "}
			...
			<p>
				...
				<span className='font-semibold'>Java</span>, aiming to deep-diving into the backend. As a{" "}
				<span className='font-semibold'>self-taught developer</span>, I'm always willing to expand my knowledge and stay up-to-date with new technologies. I'm currently seeking a full-time{" "}
				<span className='font-semibold'>software engineer</span> role, working in a{" "}
