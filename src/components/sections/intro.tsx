	...
	return (
		<section
				...
				<div className='relative mb-[2rem]'>
					<motion.div
						...
						<Image
							...
							height={192}
							width={192}
							className='h-24 w-24 rounded-full object-cover border-[0.35rem] border-white/15 shadow-custom'
						/>
					</motion.div>
					<motion.span
			...
			<motion.div
				...
				<a
					className=' bg-secondary dark:hover:text-white shadow-lg shadow-black/[0.05] px-7 h-[52px] flex items-center gap-2 rounded-full w-fit cursor-pointer hover:scale-110 duration-200'
				...
				<div className='flex flex-row gap-2'>
					<a
						title='Github'
						className='group bg-secondary dark:hover:bg-bg-white/20 shadow-lg shadow-black/[0.05] p-4 rounded-full cursor-pointer hover:scale-[1.15] duration-200'
