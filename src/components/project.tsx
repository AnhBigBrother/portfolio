...
const Project = ({ title, description, tags, imageUrl }: projectProps) => {
  ...
  return (
    <motion.div
      ...
      <section className='relative bg-white/50 dark:bg-sky-200/10 shadow-xl shadow-black/[0.03] rounded-lg max-w-[42rem] overflow-hidden sm:pr-8 sm:h-[22rem] sm:group-even:pl-8 hover:bg-sky-200/35 dark:hover:bg-sky-200/20 dark:text-white transition'>
